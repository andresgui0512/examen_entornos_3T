...
<body>
    ...
    // Consulta SQL para seleccionar todos los productos que no tienen una consola asociada
    ...
    // Con un bucle if verifica si hay resultados
    if ($resultado->num_rows > 0) {
        ...
        while ($fila = $resultado->fetch_assoc()) {
            ...
            // Cantidad de productos disponibles en la tienda
            echo "<p>Cantidad disponible: " . $fila["cantidad"] . "</p>"; 
